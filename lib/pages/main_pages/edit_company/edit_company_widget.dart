...
class _EditCompanyWidgetState extends State<EditCompanyWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'editCompany'});
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'EDIT_COMPANY_chevron_left_rounded_ICN_ON');
                                  context.safePop();
                                },
                              ),
                              Padding(
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_COMPANY_PAGE_FOUNDED_BTN_ON_TAP');
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_COMPANY_PAGE_UPDATE_BTN_ON_TAP');
                              ...
                              await CompaniesTable().update(
                                data: {
                                  ...
                                  'founded': supaSerialize<DateTime>(
                                      _model.datePicked),
                                },
