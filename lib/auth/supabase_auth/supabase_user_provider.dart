...
class ResponsiveCRMAppDesignSystemSupabaseUser extends BaseAuthUser {
  ResponsiveCRMAppDesignSystemSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> responsiveCRMAppDesignSystemSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          ResponsiveCRMAppDesignSystemSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
