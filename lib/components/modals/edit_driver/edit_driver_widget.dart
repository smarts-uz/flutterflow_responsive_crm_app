...
class _EditDriverWidgetState extends State<EditDriverWidget> {
  ...
  void initState() {
    ...
    _model.textController3 ??= TextEditingController(text: widget.model);
    _model.textController4 ??= TextEditingController(text: widget.color);
    _model.textController5 ??= TextEditingController(text: widget.carNumber);
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'EDIT_DRIVER_close_rounded_ICN_ON_TAP');
                                  context.safePop();
                                },
                              ),
                            ],
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'EDIT_DRIVER_COMP_UPDATE_BTN_ON_TAP');
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                                    return;
                                  }
                                  await DriversEDGEGroup.updateDriverCall.call(
                                    id: widget.id,
                                    firstName: _model.textController1.text,
                                    lastName: _model.textController2.text,
                                    model: _model.textController3.text,
